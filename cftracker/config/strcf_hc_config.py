class STRCFHCVOTConfig:
    ...
    search_area_scale = 5             # the scaling of the target size to get the search area
    min_image_sample_size = 200 ** 2    # minimum area of image samples
    max_image_sample_size = 250 ** 2    # maximum area of image samples
...
class STRCFHCOTBConfig:
    ...
    min_image_sample_size = 160 ** 2  # minimum area of image samples
    ...
    # learning parameters
    output_sigma_factor = 1 / 16  # label function sigma
    temporal_regularization_factor = 16
