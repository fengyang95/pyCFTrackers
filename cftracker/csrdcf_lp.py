...
from .config import csrdcf_lp_config
...
class CSRDCF_LP(BaseCF):
    def __init__(self,config=csrdcf_lp_config.CSRDCFLPConfig()):
        super(CSRDCF_LP).__init__()
    ...
    def init(self,first_frame,bbox):
        ...
        if self.use_segmentation:
            ...
            mask=self.segment_region(seg_img,self._center,self.template_size,self.base_target_sz,self.sc,
                                     hist_fg,hist_bg)
