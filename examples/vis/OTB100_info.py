OTB50=['Basketball', 'Biker', 'Bird1', 'BlurBody', 'BlurCar2',
       ...
       'Human4-2', 'Human6', 'Human9', 'Ironman', 'Jump',
...
IV=['Basketball', 'Box', 'Car1', 'Car2', 'Car24',
    ...
    'Doll', 'FaceOcc2', 'Fish', 'Human2', 'Human4-2', 'Human7',
...
SV=['Biker', 'BlurBody', 'BlurCar2', 'BlurOwl', 'Board',
    ...
    'Girl', 'Girl2', 'Gym', 'Human2', 'Human3', 'Human4-2',
    ...
    'Skater2', 'Skating1', 'Skating2-1', 'Skating2-2',
...
OCC=['Basketball', 'Biker', 'Bird2', 'Bolt', 'Box',
     ...
     'Girl2', 'Human3', 'Human4-2', 'Human5', 'Human6', 'Human7', 'Ironman',
     'Jogging-1', 'Jogging-2', 'Jump', 'KiteSurf', 'Lemming', 'Liquor', 'Matrix', 'Panda',
     'RedTeam', 'Rubik', 'Singer1', 'Skating1', 'Skating2-1', 'Skating2-2', 'Soccer',
...
DEF=['Basketball', 'Bird1', 'Bird2', 'BlurBody', 'Bolt', 'Bolt2',
     ...
     'Gym', 'Human3', 'Human4-2', 'Human5', 'Human6', 'Human7', 'Human8', 'Human9',
     'Jogging-1', 'Jogging-2', 'Jump', 'Mhyang', 'Panda', 'Singer2', 'Skater', 'Skater2', 'Skating1', 'Skating2-1',
