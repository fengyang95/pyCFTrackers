...
if __name__ == '__main__':
    ...
    trackers=['MCCTH-Staple','STRCF','MKCFup-LP','MKCFup','CSRDCF-LP','DSST-LP','LDES','SAMF','Staple-CA','OPENCV-CSRDCF','DCF','MOSSE','KCF','CSK','Staple','DSST','CN','DAT','ECO-HC','ECO','BACF','CSRDCF']
    print(trackers)
